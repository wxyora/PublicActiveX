...
public class Constants {
    ...
    public static final Boolean OPEN_LOG_FLAG = true;
    public static final String APP_NAME = "车首付";
    ...
    public static final String ZX_REPORT = "zxreport";
    public static final String UPLOAD_API = "/sq/borrow/upload-loan-app-files";
    public static final String ALLINPAY_KEY = "1234567890";
    public static final String DOWN_LOAD_PATH = "/sdcard/happyfi/";
    public static final String GET_PBOC_VERIFY_CODE = "https://ipcrs.pbccrc.org.cn/imgrc.do?";
